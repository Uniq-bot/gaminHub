    ...
    <div className="w-full h-130 flex items-center justify-center py-20">
      <div className="flex items-center flex-col">
        ...
        <div className="flex mt-5 gap-10">
          <Link href={'/'} className="px-10 py-3 bg-gradient-to-r from-cyan-500 to-blue-500 text-white font-bold font-[Orbitron] rounded-lg hover:shadow-lg hover:shadow-cyan-500/50 flex items-center gap-2 transition-all">
           <View /> View Library
          </Link>
